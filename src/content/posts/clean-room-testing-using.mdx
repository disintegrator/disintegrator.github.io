...
summary: A slick approach to test encapsulation when using a database
...
setting up resources like databases and mockservers but this doesn't have to be
...
Now, JavaScript and TypeScript now have syntax and a runtime primitive for
