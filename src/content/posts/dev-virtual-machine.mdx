...
bluesky: https://bsky.app/profile/disintegrator.dev/post/3lehkplf37c23
---
...
<blockquote class="twitter-tweet">
	<p lang="en" dir="ltr">
		I switched my primary dev environment to a graphical NixOS VM on a macOS
		host. It has been wonderful. I can keep the great GUI ecosystem of macOS,
		but all dev tools are in a full screen VM. One person said “it basically
		replaced your terminal app” which is exactly how it feels.
	</p>
	&mdash; Mitchell Hashimoto (@mitchellh){" "}
	<a href="https://twitter.com/mitchellh/status/1346136404682625024?ref_src=twsrc%5Etfw">
		January 4, 2021
	</a>
</blockquote> <script
	async
...
<ImageLink
	src={vscExt}
	alt="A screenshot of VS Code showing most extensions installed and running inside the VM"
/>{" "}
...
<ImageLink
	src={tmuxIterm2}
	alt="iTerm2 with tmux integration showing how windows and panes map to native tabs and splits"
/>{" "}
...
<ImageLink
	src={ssh1p}
	alt="Running git fetch in my development VM triggers the 1Password prompt to grant access to the key"
/>
